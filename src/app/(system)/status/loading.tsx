...
export default function LoadingPage() {
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(255,145,0,0.12),transparent_35%),radial-gradient(circle_at_80%_10%,rgba(80,146,117,0.15),transparent_30%),radial-gradient(circle_at_50%_80%,rgba(255,255,255,0.08),transparent_40%)]"/>
                ...
                {meteorSeeds.map((seed, index) => (
                    ...
                    >
                        <div
                            className="absolute -right-10 top-1/2 h-[2px] w-10 -translate-y-1/2 bg-gradient-to-l from-orange-400/70 via-yellow-300/50 to-transparent blur-[1px]"/>
                    </div>
                ))}
            </div>
