    ...
    <div className="flex flex-col min-h-screen overflow-y-scroll overflow-x-hidden scroll-smooth">
      ...
      >
        ...
        <div className="flex justify-between">
          ...
          <button className="px-15 cursor-pointer md:text-[14px] text-[10px]" onClick={() => router.push("/authentication")}><p className="outfit-regular border-0 bg-white text-black rounded-[100px] px-5 py-2">Login</p></button>
        </div>
        ...
        {/* for the find your roommate today button */}
          <div className="flex justify-center items-center">
            <button className="bg-white/10 md:px-7 md:py-4 p-2 rounded-[100px] border-0 md:text-[24px] text-[10px] flex justify-center button-find cursor-pointer mt-2 hover:bg-gradient-to-br from-orange-400 to-yellow-500 transition duration-2000 ease-linear" onClick={() => router.push("/authentication")}>Find Your Roommate Today</button>
          </div>
        </div>

        {/* Second screen */}
        <div className="w-screen min-h-screen bg-black flex flex-col justify-center items-center" style={{ backgroundImage: `url('/images/stars.png')` }}>
          <h1 className="text-white text-[60px] font-extrabold">Fast Solution and Best Matches</h1>
          <p className="text-white inter-tight-regular text-[20px]">Find your ideal roommate match with our comprehensive platform</p>
          <p className="text-white inter-tight-regular mb-8 text-[20px]">designed specificially for students just like you</p>
          <div className="grid grid-cols-3 gap-10">
            ...
            <div className="inter-tight-regular text-black bg-white border-0 rounded-xl flex flex-col text-center justify-center items-center px-8 py-5 w-80 h-60">
              <img src="/images/landing_logo1_S2.png" alt="AI Powered" className="md:w-22 md:h-17 justify-center items-center "/>
              <h1 className="font-bold h-10 ">AI Powered Matchmaking</h1>
              <p className="h-30">Our advanced algorithm analyzes personality traits and preferences to find you the ideal roommate.</p>
            </div>
            
            <div className="inter-tight-regular text-black bg-white border-0 rounded-xl flex flex-col text-center justify-center items-center px-8 py-5 w-80 h-60">
              <img src="/images/L2.png" alt="AI Powered" className="md:w-23 md:h-17 justify-center items-center"/>
              <h1 className="font-bold h-10">Data Driven Insights</h1>
              <p className="h-30">View comprehensive compatibility metrics and compare potential roommates using interactive charts and graphs.</p>
            </div>

            <div className="inter-tight-regular text-black bg-white border-0 rounded-xl flex flex-col text-center justify-center items-center px-8 py-5 w-80 h-60">
              <img src="/images/L3.png" alt="AI Powered" className="md:w-25 md:h-17 justify-center items-center"/>
              <h1 className="font-bold h-10">Multistep Verification</h1>
              <p className="h-30">Secure system with your school email and social media verification ensures all users are genuine UTD students.</p>
            </div>

            <div className="inter-tight-regular text-black bg-white border-0 rounded-xl flex flex-col text-center justify-center items-center px-8 py-5 w-80 h-60">
              <img src="/images/L4.png" alt="AI Powered" className="md:w-29 md:h-18 justify-center items-center"/>
              <h1 className="font-bold h-10">Privacy First</h1>
              <p className="h-30">Your data is always protected. You control what information you share and who can see it.</p>
            </div>

            <div className="inter-tight-regular text-black bg-white border-0 rounded-xl flex flex-col text-center justify-center items-center px-8 py-5 w-80 h-60">
              <img src="/images/L5.png" alt="AI Powered" className="md:w-22 md:h-17 justify-center items-center"/>
              <h1 className="font-bold h-10">Personalized Matchmaking</h1>
              <p className="h-30">Tinder styled swiping interface with detailed profile and compatibility scores makes finding your roommate fun and intuitive.</p>
            </div>

            <div className="inter-tight-regular text-black bg-white border-0 rounded-xl flex flex-col text-center justify-center items-center px-8 py-5 w-80 h-60">
              <img src="/images/L6.png" alt="AI Powered" className="md:w-25 md:h-20 justify-center items-center"/>
              <h1 className="font-bold h-10">Social Integration</h1>
              <p className="h-30">Optional social media connection for enhanced matching and verification.</p>
            </div>
