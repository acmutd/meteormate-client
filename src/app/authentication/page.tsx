...
export default function LoginPage() {
	...
	useEffect(() => {
		if (userLoggedIn) {
			router.push("../authentication/createAccount"); // CHANGE HERE ONCE THE HOME PAGE IS UP
		}
	}, [userLoggedIn, router]);
	...
	const handleLogin = async () => {
		...
		try {
			if (!isSigningIn) {
				...
				router.push("../authentication/createAccount"); // redirect after login CHANGE HERE ONCE THE HOME PAGE IS UP
			}
		} catch (err: any) {
			//just in case there's a problem signing in
