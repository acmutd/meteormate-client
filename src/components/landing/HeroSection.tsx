            ...
            <div className="container mx-auto px-6 z-10 relative">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16 lg:gap-24">
                    ...
                    <div className="text-center lg:text-left max-w-lg lg:max-w-xl order-2 lg:order-1 lg:row-start-1">
                        ...
                        {/* Badge */}
                        <div
                            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-xs font-semibold text-primary-hover mb-8 mx-auto lg:mx-0">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inset-0 rounded-full bg-primary opacity-75"/>
                <span className="relative inset-0 rounded-full bg-primary-hover"/>
              </span>
