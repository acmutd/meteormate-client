...
export default function GetStarted() {
    ...
    return (
        <LandingSection
            id="getStarted"
            className="min-h-screen bg-black bg-no-repeat bg-center bg-cover text-white flex flex-col items-center justify-center"
            style={{
                backgroundImage: `url('/landing_grayscale_comets.webp')`,
            }}
        >
